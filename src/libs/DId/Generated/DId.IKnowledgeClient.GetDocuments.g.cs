...
namespace DId
{
    public partial interface IKnowledgeClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DId.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::DId.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::DId.GetDocumentsResponseItem>>> GetDocumentsAsResponseAsync(
            string knowledgeId,
            global::DId.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
