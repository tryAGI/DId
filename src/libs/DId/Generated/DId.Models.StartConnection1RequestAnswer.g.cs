...
namespace DId
{
    ...
    public sealed partial class StartConnection1RequestAnswer
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DId.JsonConverters.StartConnection1RequestAnswerTypeJsonConverter))]
        public global::DId.StartConnection1RequestAnswerType Type { get; set; }
        ...
        public StartConnection1RequestAnswer(
            string sdp,
            global::DId.StartConnection1RequestAnswerType type)
        {
            this.Type = type;
