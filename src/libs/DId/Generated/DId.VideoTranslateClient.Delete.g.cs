...
namespace DId
{
    public partial class VideoTranslateClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DId.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DId.AutoSDKHttpResponse> DeleteAsResponseAsync(
            string id,
            global::DId.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                else
                {
                    await global::DId.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::DId.DeleteResponse? __value_401 = null;
                                try
                                {
                                ...
                                throw global::DId.ApiException<global::DId.DeleteResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::DId.DeleteResponse2? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                ...
                                throw global::DId.ApiException<global::DId.DeleteResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                global::DId.DeleteResponse3? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                ...
                                throw global::DId.ApiException<global::DId.DeleteResponse3>.Create(
                                    statusCode: __response.StatusCode,
