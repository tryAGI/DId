...
namespace DId
{
    ...
    public sealed partial class CreateStream1ResponseJsep
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DId.JsonConverters.CreateStream1ResponseJsepTypeJsonConverter))]
        public global::DId.CreateStream1ResponseJsepType Type { get; set; }
        ...
        public CreateStream1ResponseJsep(
            string sdp,
            global::DId.CreateStream1ResponseJsepType type)
        {
