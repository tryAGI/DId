...
namespace DId
{
    ...
    public sealed partial class AudioScript3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DId.JsonConverters.AudioScript3TypeJsonConverter))]
        public global::DId.AudioScript3Type Type { get; set; }
        ...
        public AudioScript3(
            string audioUrl,
            global::DId.AudioScript3Type type,
            bool? subtitles)
        {
