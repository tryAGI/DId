...
namespace DId
{
    ...
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::DId.ListResponseConsentStatus?), TypeInfoPropertyName = "NullableListResponseConsentStatus2")]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::DId.GetResponseStatus2?), TypeInfoPropertyName = "NullableGetResponseStatus22")]
    ...
    internal sealed partial class ConsentsSourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class ConsentsSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static ConsentsSourceGenerationContext Default { get; } = new(DefaultOptions);

        private ConsentsSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            ...
            {
                return
                    typeToConvert == typeof(global::DId.ListResponseConsentStatus)

                    || typeToConvert == typeof(global::DId.ListResponseConsentStatus?)

                    || typeToConvert == typeof(global::DId.GetResponseStatus2)
            ...
            {
                if (typeToConvert == typeof(global::DId.ListResponseConsentStatus))
                {
                    return new global::DId.JsonConverters.ListResponseConsentStatusJsonConverter();
                }

                if (typeToConvert == typeof(global::DId.ListResponseConsentStatus?))
                {
                    return new global::DId.JsonConverters.ListResponseConsentStatusNullableJsonConverter();
                }

                if (typeToConvert == typeof(global::DId.GetResponseStatus2))
                {
                    return new global::DId.JsonConverters.GetResponseStatus2JsonConverter();
                }

                if (typeToConvert == typeof(global::DId.GetResponseStatus2?))
                {
                    return new global::DId.JsonConverters.GetResponseStatus2NullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new ConsentsSourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
