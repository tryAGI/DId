...
namespace DId
{
    ...
    public sealed partial class GetSettingsResponseAgents
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DId.JsonConverters.GetSettingsResponseAgentsLlmModelJsonConverter))]
        public global::DId.GetSettingsResponseAgentsLlmModel? LlmModel { get; set; }
        ...
        public GetSettingsResponseAgents(
            ...
            double? numOrigins,
            double? sessionTtl,
            global::DId.GetSettingsResponseAgentsLlmModel? llmModel,
