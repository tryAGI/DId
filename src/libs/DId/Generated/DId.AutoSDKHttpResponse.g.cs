...
namespace DId
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::DId.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::DId.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::DId.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::DId.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::DId.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::DId.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::DId.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::DId.ApiException exception)
        ...
        private static global::DId.AutoSDKRequestOptions CloneRequestOptions(
            global::DId.AutoSDKRequestOptions? source)
        {
            var clone = new global::DId.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
