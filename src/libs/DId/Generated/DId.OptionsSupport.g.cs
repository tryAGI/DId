...
namespace DId
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::DId.AutoSDKRetryOptions Retry { get; set; } = new global::DId.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::DId.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::DId.IAutoSDKHook>();
        ...
        public global::DId.AutoSDKClientOptions AddHook(
            global::DId.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::DId.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::DId.AutoSDKClientOptions UseAuthorizationProvider(
            global::DId.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::DId.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::DId.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::DId.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::DId.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::DId.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::DId.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::DId.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::DId.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::DId.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::DId.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::DId.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::DId.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::DId.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::DId.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::DId.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        internal static global::DId.AutoSDKHookContext CreateHookContext(
            ...
            global::DId.AutoSDKClientOptions clientOptions,
            global::DId.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::DId.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::DId.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::DId.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::DId.AutoSDKClientOptions clientOptions,
            global::System.Func<global::DId.IAutoSDKHook, global::DId.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::DId.AutoSDKHookContext context)
        {
