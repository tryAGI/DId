...
namespace DId
{
    ...
    public sealed partial class AnswerJsep
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DId.JsonConverters.AnswerJsepTypeJsonConverter))]
        public global::DId.AnswerJsepType Type { get; set; }
        ...
        public AnswerJsep(
            string sdp,
            global::DId.AnswerJsepType type)
        {
            this.Type = type;
