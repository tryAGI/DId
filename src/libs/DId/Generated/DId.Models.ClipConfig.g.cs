...
namespace DId
{
    ...
    public sealed partial class ClipConfig
    {
        ...
        public global::DId.ClipConfigLogo? Logo { get; set; }
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DId.JsonConverters.ClipConfigResultFormatJsonConverter))]
        public global::DId.ClipConfigResultFormat? ResultFormat { get; set; }
...
#endif
        public ClipConfig(
            global::DId.ClipConfigLogo? logo,
            global::DId.ClipConfigResultFormat? resultFormat,
