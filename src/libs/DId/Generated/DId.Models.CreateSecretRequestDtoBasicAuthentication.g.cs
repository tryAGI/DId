...
namespace DId
{
    ...
    public sealed partial class CreateSecretRequestDtoBasicAuthentication
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DId.JsonConverters.CreateSecretRequestDtoBasicAuthenticationTypeJsonConverter))]
        public global::DId.CreateSecretRequestDtoBasicAuthenticationType Type { get; set; }
        ...
        public CreateSecretRequestDtoBasicAuthentication(
            string provider,
            string username,
            global::DId.CreateSecretRequestDtoBasicAuthenticationType type,
            string? password)
        {
            this.Type = type;
