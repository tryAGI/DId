...
namespace DId
{
    public partial class AgentsClient
    {
        ...
        partial void PrepareListMyAgentsArguments(
            ...
            ref global::DId.ListMyAgentsOrder? order,
            ref double? limit,
            ref string? token);
        partial void PrepareListMyAgentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::DId.ListMyAgentsSortBy? sortBy,
            global::DId.ListMyAgentsOrder? order,
            double? limit,
            string? token);
        ...
        public async global::System.Threading.Tasks.Task<global::DId.ListMyAgentsResponse> ListMyAgentsAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DId.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DId.AutoSDKHttpResponse<global::DId.ListMyAgentsResponse>> ListMyAgentsAsResponseAsync(
            global::DId.ListMyAgentsSortBy? sortBy = default,
            global::DId.ListMyAgentsOrder? order = default,
            double? limit = default,
            string? token = default,
                ...
                else
                {
                    await global::DId.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::DId.ListMyAgentsResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::DId.ListMyAgentsResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::DId.ApiException<global::DId.ListMyAgentsResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DId.ListMyAgentsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DId.AutoSDKHttpResponse<global::DId.ListMyAgentsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DId.ListMyAgentsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
