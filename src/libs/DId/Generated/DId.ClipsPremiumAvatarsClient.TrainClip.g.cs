...
namespace DId
{
    public partial class ClipsPremiumAvatarsClient
    {
        ...
        private static readonly global::DId.EndPointSecurityRequirement s_TrainClipSecurityRequirement0 =
        ...
        private static readonly global::DId.EndPointSecurityRequirement[] s_TrainClipSecurityRequirements =
            new global::DId.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::DId.TrainClipResponse> TrainClipAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DId.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DId.AutoSDKHttpResponse<global::DId.TrainClipResponse>> TrainClipAsResponseAsync(
                ...
                else
                {
                    await global::DId.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::DId.TrainClipResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::DId.TrainClipResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::DId.ApiException<global::DId.TrainClipResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DId.TrainClipResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DId.AutoSDKHttpResponse<global::DId.TrainClipResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DId.TrainClipResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
