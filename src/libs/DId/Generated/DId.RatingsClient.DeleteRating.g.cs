...
namespace DId
{
    public partial class RatingsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DId.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DId.AutoSDKHttpResponse<global::DId.DeleteRatingResponse>> DeleteRatingAsResponseAsync(
            string agentId,
            string chatId,
            string ratingId,
            global::DId.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::DId.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::DId.ApiException<global::DId.DeleteRatingResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DId.DeleteRatingResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DId.AutoSDKHttpResponse<global::DId.DeleteRatingResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DId.DeleteRatingResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
