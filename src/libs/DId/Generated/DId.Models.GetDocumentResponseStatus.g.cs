...
namespace DId
{
    ...
    /// 
    /// </summary>
    public enum GetDocumentResponseStatus
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    /// </summary>
    public static class GetDocumentResponseStatusExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this GetDocumentResponseStatus value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static GetDocumentResponseStatus? ToEnum(string value)
        {
            return value switch
            {
