...
namespace DId
{
    public partial class ScenesExpressAvatarsClient
    {
        ...
        private static readonly global::DId.EndPointSecurityRequirement s_Delete2SecurityRequirement0 =
        ...
        private static readonly global::DId.EndPointSecurityRequirement[] s_Delete2SecurityRequirements =
            new global::DId.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DId.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DId.AutoSDKHttpResponse> Delete2AsResponseAsync(
            string id,
            global::DId.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    await global::DId.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::DId.Delete2Response? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::DId.Delete2Response.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::DId.ApiException<global::DId.Delete2Response>.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::DId.Delete2Response2? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::DId.Delete2Response2.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::DId.ApiException<global::DId.Delete2Response2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::DId.Delete2Response3? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::DId.Delete2Response3.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::DId.ApiException<global::DId.Delete2Response3>.Create(
                                    statusCode: __response.StatusCode,
                ...
                return new global::DId.AutoSDKHttpResponse(
                                        statusCode: __response.StatusCode,
