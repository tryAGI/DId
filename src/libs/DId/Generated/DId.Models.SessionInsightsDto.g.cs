...
namespace DId
{
    ...
    public sealed partial class SessionInsightsDto
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DId.JsonConverters.SessionInsightsDtoOutcomeJsonConverter))]
        public global::DId.SessionInsightsDtoOutcome? Outcome { get; set; }
        ...
        public SessionInsightsDto(
            string? headline,
            global::DId.SessionInsightsDtoOutcome? outcome)
        {
