...
namespace DId
{
    ...
    public sealed partial class CreateStreamScriptAudio
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::DId.JsonConverters.CreateStreamScriptAudioTypeJsonConverter))]
        public global::DId.CreateStreamScriptAudioType Type { get; set; }
        ...
        public CreateStreamScriptAudio(
            string audioUrl,
            global::DId.CreateStreamScriptAudioType type)
        {
