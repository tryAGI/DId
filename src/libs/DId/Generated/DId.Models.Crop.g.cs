...
namespace DId
{
    ...
    public readonly partial struct Crop : global::System.IEquatable<Crop>
    {
...
#else
        public global::DId.CropVariant1? CropVariant1 { get; }
#endif
        ...
        /// </summary>
#if NET6_0_OR_GREATER
        public global::DId.CropVariant2? CropVariant2 { get; init; }
#else
        public global::DId.CropVariant2? CropVariant2 { get; }
#endif
        ...
        public Crop(
            ...
            global::DId.CropVariant2? cropVariant2
            )
        {
